...
CHALLNAME = "DoubleTrouble"
DESCRIPTION_HTML = "In this challenge, you'll need to grasp every single detail of what you're doing.<br>No guesswork allowed.<br>Dive deep, analyze thoroughly, and most importantly, enjoy the process !"
...
HARDFORK = "shanghai" # Can be latest, cancun, shanghai, london, paris, ...
